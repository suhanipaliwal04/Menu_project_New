...
from app.api.v1.endpoints import areas, restaurants, menus, chat, admin, auth, voice, dine
...
api_router.include_router(dine.router,        prefix="/dine",        tags=["Dine-In Booking"])
